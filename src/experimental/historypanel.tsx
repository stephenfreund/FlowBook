/**
 * History Panel for FlowBook - Photoshop-style undo/redo
 */
...
function HistoryPanelComponent(props: HistoryPanelProps): JSX.Element {
  ...
  return (
    <div className="flowbook-history-panel">
      <div className="flowbook-history-controls">
        <button
          className="flowbook-history-button"
          onClick={handleUndo}
          disabled={!canUndo}
          title="Undo"
        >
      ...
      <div className="flowbook-history-list">
        {entries.map((entry, index) => {
          ...
          return (
            <div
              ...
              title={description}
            >
              <div className="flowbook-history-entry-icon">
                <LabIcon.resolveReact
                  icon={entry.icon}
                  className="flowbook-history-icon"
                  tag="span"
                />
              </div>
              <div className="flowbook-history-entry-content">
                <div className="flowbook-history-entry-label">
                  {entry.type === 'command' ? entry.commandLabel : 'User Edit'}
                </div>
                <div className="flowbook-history-entry-description">
                  {description}
                </div>
              </div>
            </div>
...
export class HistoryPanel extends ReactWidget {
  ...
  constructor(tracker: INotebookTracker, historyManager: NotebookHistoryManager) {
    ...
    this.addClass('flowbook-history-widget');
    this.title.label = 'FlowBook History';
