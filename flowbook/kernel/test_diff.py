...
from flowbook.kernel.types import ValueComparison, CompoundDiff, DiffNode, DiffResult
...
class TestDataFrameSeriesSubclasses:
    ...
    def test_dispatch_cache_populated_for_subclass(self):
        ...
        from flowbook.kernel.diff import _DISPATCH_CACHE
...
class TestDeferredKerasImport:
    ...
    def test_is_keras_model_detection_without_import(self):
        ...
        from flowbook.kernel.diff import _is_keras_model
    ...
    def test_diff_does_not_register_keras_for_non_keras_objects(self):
        ...
        from flowbook.kernel import diff as diff_module
    ...
    def test_keras_handler_registration_is_idempotent(self):
        ...
        from flowbook.kernel.diff import _register_keras_dispatch_if_needed
        from flowbook.kernel import diff as diff_module
