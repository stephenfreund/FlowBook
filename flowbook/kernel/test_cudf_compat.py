...
from flowbook.kernel.column_tracking import ColumnAccessTracker
...
class TestStructuralTrackingProxyUnwrap:
    ...
    def test_unwrap_cudf_proxy_returns_non_proxy_unchanged(self):
        ...
        from flowbook.kernel.structural_tracking import _unwrap_cudf_proxy
    ...
    def test_structural_tracking_no_recursion_with_pandas(self):
        ...
        from flowbook.kernel.structural_tracking import StructuralAccessTracker
