...
class TestFlowbookDeepCopy:
    """Tests for flowbook_deepcopy with Keras models."""
    ...
    def test_trained_model_copy(self, trained_model):
        ...
        model_copy = flowbook_deepcopy(trained_model)
...
class TestFunctionalModel:
    ...
    def test_functional_copy(self, functional_model):
        ...
        model_copy = flowbook_deepcopy(functional_model)
