"""
FlowbookKernel - Enhanced IPython kernel with profiling, checkpoints, and tracking.

This module provides the core kernel implementation for FlowBook, extending
IPython's kernel with advanced features for notebook analysis and optimization.

Architecture Overview:
    FlowbookKernel extends IPythonKernel and Magics to provide:
...
Key Components:
    - FlowbookKernel: Main kernel class (this file)
...
Usage:
    The kernel is launched via the standard Jupyter kernel mechanism:
        ...
        python -m flowbook.kernel.flowbook_kernel

    Or via the installed kernel spec "flowbook".
"""
...
from flowbook.kernel.display_helpers import DisplayHelper
from flowbook.kernel.flowbook_pdb import FlowbookPdb
from flowbook.kernel.json_utils import make_json_safe
from flowbook.kernel.kernel_command_handlers import KernelCommandHandlers
from flowbook.kernel.kernel_commands import FinalMessage
from flowbook.kernel.models import ExecutionContext, ExecutionMetadata, ExecutionProfile, TrackingData
from flowbook.kernel.monotonicity import MonotonicityEnforcer
from flowbook.kernel.scalene_runner import ScaleneRunner
from flowbook.kernel.timeout_handler import CellTimeoutHandler
from flowbook.kernel.tracking import TrackingDict
from flowbook.util.output import log, output
...
class FlowbookKernel(IPythonKernel, Magics):
    ...
    def _remove_non_deepcopyable_objects(self) -> None:
        ...
        from flowbook.kernel.checkpoint import filter_user_namespace
