...
from flowbook.kernel.column_tracking import ColumnAccessTracker, walk_dataframes, walk_pandas_objects
from flowbook.kernel.structural_tracking import StructuralAccessTracker, StructuralTrackingMode
...
def count_patched_methods():
    ...
    from flowbook.kernel.structural_tracking import STRUCTURE_USING_METHODS, PANDAS_FUNCTIONS_TO_WRAP
