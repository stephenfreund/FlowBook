...
This module provides a Python client for sending commands to the FlowbookKernel
...
from flowbook.kernel.kernel_commands import (
...
from flowbook.util.output import error, timer
...
class KernelCommandClient:
    """
    Client for sending commands to FlowbookKernel via comm channel.
