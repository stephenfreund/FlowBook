"""
Tests for SDC Enforcer integration with structural tracking.

These tests verify that the SDCEnforcer correctly handles structural reads,
...
from flowbook.sdc_kernel.sdc_enforcer import SDCEnforcer
from flowbook.sdc_kernel.models import SDCViolation


class TestSDCEnforcerBaseline:
    ...
    def enforcer(self, checkpoints):
        """Create an SDCEnforcer instance."""
        return SDCEnforcer(checkpoints)
    ...
    def test_no_backward_mutation_without_structural(self):
        ...
        enforcer = SDCEnforcer(checkpoints)
...
class TestSDCStructuralReadsModeOff:
    """Tests for SDC with structural_mode=OFF."""
    ...
    def test_off_mode_ignores_structural_reads(self):
        ...
        ns_a = {'df': df}
        pre_a = Checkpoint('pre_a', ns_a, {})
        post_a = Checkpoint('post_a', ns_a, {})
        ...
        ns_b_post = {'df': df_b}
        pre_b = Checkpoint('pre_b', ns_a, {})
        post_b = Checkpoint('post_b', ns_b_post, {})
...
class TestSDCStructuralReadsModeWarn:
    """Tests for SDC with structural_mode=WARN."""
...
class TestSDCStructuralReadsModeEnforce:
    """Tests for SDC with structural_mode=ENFORCE."""
    ...
    def test_enforce_columns_read_blocks_column_addition(self):
        ...
        df_b = pd.DataFrame({'a': [1], 'b': [2], 'c': [3]})
        ns_b_post = {'df': df_b}
        pre_b = Checkpoint('pre_b', {'df': df.copy()}, {})
        post_b = Checkpoint('post_b', ns_b_post, {})
...
class TestSDCStructuralStaleness:
    ...
    def test_staleness_when_columns_changed(self):
        ...
        ns_b = ns_a.copy()
        pre_b = Checkpoint('pre_b', ns_b, {})
        post_b = Checkpoint('post_b', ns_b, {})
        ...
        ns_c_post = {'df': df_c}
        pre_c = Checkpoint('pre_c', ns_a.copy(), {})
        post_c = Checkpoint('post_c', ns_c_post, {})
...
class TestSDCStructuralMultipleVariables:
    ...
    def test_multiple_dataframes_independent(self):
        ...
        pre_b = Checkpoint('pre_b', ns_a.copy(), {})
        post_b = Checkpoint('post_b', ns_b_post, {})
...
class TestSDCStructuralSeriesTracking:
    """Tests for Series structural tracking in SDC."""
    ...
    def test_series_index_read_blocks_length_change(self):
        ...
        ns_b_post = {'s': s_b}
        pre_b = Checkpoint('pre_b', {'s': s.copy()}, {})
        post_b = Checkpoint('post_b', ns_b_post, {})
...
class TestSDCStructuralNestedPaths:
    ...
    def test_nested_path_structural_read(self):
        ...
        pre_b = Checkpoint('pre_b', {'data': {'train': df.copy()}}, {})
        post_b = Checkpoint('post_b', ns_b_post, {})
