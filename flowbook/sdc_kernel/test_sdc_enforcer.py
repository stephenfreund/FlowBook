...
class TestTruncationDetection:
    ...
    def test_no_truncation_empty_diff(self):
        ...
        from flowbook.sdc_kernel.sdc_enforcer import _check_for_truncation
    ...
    def test_truncation_detected_in_dict(self):
        ...
        from flowbook.kernel.types import DiffResult, ValueComparison, CompoundDiff
        from flowbook.sdc_kernel.sdc_enforcer import _check_for_truncation, _format_diff_for_display
...
class TestDeepAliasIntegration:
    ...
    def test_backward_mutation_through_nested_alias(self):
        ...
        from flowbook.sdc_kernel.sdc_enforcer import _expand_with_deep_aliases
