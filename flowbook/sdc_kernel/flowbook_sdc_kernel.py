"""
FlowbookSDCKernel - IPython kernel with Sequential Dataflow Consistency enforcement.
...
from flowbook.kernel import extended_types
from flowbook.kernel.checkpoint import Checkpoint, Checkpoints, filter_user_namespace
...
@magics_class
class FlowbookSDCKernel(IPythonKernel, Magics):
    """
    ...
    implementation = "flowbook_sdc_kernel"
    implementation_version = "0.1"
    banner = "FlowBook SDC Kernel - Sequential Dataflow Consistency"
