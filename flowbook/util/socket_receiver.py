...
class SocketOutputReceiver:
    ...
    Usage:
        receiver = SocketOutputReceiver("/tmp/flowbook_123.sock")
        receiver.start()
    ...
    Or as context manager:
        with SocketOutputReceiver.create() as (receiver, socket_path):
            os.environ["FLOWBOOK_OUTPUT_SOCKET"] = socket_path
            # ... run kernel operations ...
    """
    ...
    @classmethod
    def create(cls, prefix: str = "flowbook") -> "SocketOutputReceiver":
        """
...
def setup_socket_receiver(prefix: str = "flowbook") -> tuple:
    """
    ...
    and signals, and sets the FLOWBOOK_OUTPUT_SOCKET environment variable.
