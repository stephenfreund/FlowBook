...
class TestGenerateTestsCommand:
    ...
    async def test_generate_tests_adds_to_existing(self):
        ...
        with patch('flowbook.server.commands.generate_tests.FlowbookAgent.make_and_run_agent') as mock_agent:
            ...
            assert len(flowbook_meta.unit_tests.tests) == 3  # 1 existing + 2 new
