...
from flowbook.util.flowbook_metadata import (
    ...
    set_optimized_flowbook_metadata,
    set_optimization_applied_flowbook_metadata,
)
...
from flowbook.util.output import log, error, timer, indent, print
...
class CodeExecutionOrchestrator:
    ...
    def __init__(self, kernel_client: FlowbookKernelClient):
...
class ValidationHelper:
    ...
    def validate_optimization(
        ...
        Args:
            ...
            kernel_client: FlowbookKernelClient for executing operations
            pre_post_envs: Optional pre-existing checkpoints to skip original execution
...
class StatsAggregator:
    ...
    def add_stats(self, stats: FlowbookStats) -> None:
    ...
    def get_aggregated_stats(self) -> FlowbookStats:
    ...
    def get_empty_stats(self) -> FlowbookStats:
...
class OptimizeCommand(NotebookCommand):
    ...
    async def _repair_optimization(
        ...
        agent: FlowbookAgent[RepairedOptimizationResponse],
        prompt_key: str,
        ...
        with timer(
            ...
            target_flowbook_metadata = FlowbookMetadata.from_cell(cell)
            target_profile = target_flowbook_metadata.get_profile()
    ...
    def _extract_target_cell_and_metadata(
        ...
        target_flowbook_metadata = FlowbookMetadata.from_cell(target_cell)
        target_profile = target_flowbook_metadata.get_profile()
    ...
    async def _run_llm_optimization(
        ...
        tools: NotebookTools,
        stats_aggregator: StatsAggregator,
    ) -> Tuple[OptimizedCodeResponse, FlowbookStats]:
        """
        ...
        """
        agent = FlowbookAgent[OptimizedCodeResponse](
    ...
    async def _run_batch_llm_optimization(
        ...
        tools: NotebookTools,
        stats_aggregator: StatsAggregator,
    ) -> Tuple[BatchOptimizedCodeResponse, FlowbookStats]:
        """
        ...
        """
        agent = FlowbookAgent[BatchOptimizedCodeResponse](
    ...
    def _get_optimization_plan(
        ...
        optimization_potential = flowbook_metadata.get_optimization_potential()
    ...
    def _identify_cells_to_optimize(
        ...
        for index, cell in enumerate(nb["cells"]):
            if cell["cell_type"] == "code":
                ...
                flowbook_metadata = FlowbookMetadata.from_cell(cell)
                opt_potential = flowbook_metadata.get_optimization_potential()
