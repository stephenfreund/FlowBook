...
Example usage:
    ...
    From CLI: flowbook_split notebook.ipynb -o notebook_split.ipynb
"""
...
from flowbook.agent.llm_cost import Usage
...
from flowbook.util.output import error, indent, log, timer
...
class StatsAggregator:
    ...
    def __init__(self):
        self.all_stats: List[FlowbookStats] = []
...
class SplitCommand(NotebookCommand):
    ...
    async def split_cell(
        ...
        agent = FlowbookAgent[SplitCellResponse](
            key="cell_splitting",
            model=model,
