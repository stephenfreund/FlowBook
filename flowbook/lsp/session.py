...
class LspSession(MethodDispatcher):
    ...
    def __enter__(self):
        ...
        cache_dir = os.path.join(os.path.expanduser("~"), ".cache", "flowbook-jedi")
        ...
        self._writer = JsonRpcStreamWriter(os.fdopen(self._sub.stdin.fileno(), "wb"))  # type: ignore
        self._reader = JsonRpcStreamReader(os.fdopen(self._sub.stdout.fileno(), "rb"))  # type: ignore
    ...
    def __exit__(self, typ, value, _tb):
        self.shutdown(True)
        try:
            self._sub.terminate()  # type: ignore
        except Exception:
            pass
        self._endpoint.shutdown()  # type: ignore
    ...
    def initialized(self, initialized_params=None):
        ...
        if initialized_params is None:
            initialized_params = {}
        self._endpoint.notify("initialized", initialized_params)  # type: ignore
    ...
    def exit_lsp(self, exit_timeout=LSP_EXIT_TIMEOUT):
        ...
        self._endpoint.notify("exit")  # type: ignore
        assert self._sub.wait(exit_timeout) == 0  # type: ignore
    ...
    def _send_request(self, name, params=None, handle_response=lambda f: f.done()):
        ...
        fut = self._endpoint.request(name, params)  # type: ignore
    ...
    def _send_notification(self, name, params=None):
        ...
        self._endpoint.notify(name, params)  # type: ignore
