"""
ExperimentalKernel - Enhanced IPython kernel with profiling, checkpoints, and tracking.
...
Architecture Overview:
    ExperimentalKernel extends IPythonKernel and Magics to provide:
...
Key Components:
    - ExperimentalKernel: Main kernel class (this file)
...
from flowbook.kernel_support.flowbook_pdb import FlowbookPdb
...
@magics_class
class ExperimentalKernel(IPythonKernel, Magics):
    """
