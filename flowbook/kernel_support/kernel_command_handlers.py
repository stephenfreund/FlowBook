...
if TYPE_CHECKING:
    ...
    from flowbook.kernel_support.flowbook_kernel import FlowbookKernel
...
class KernelCommandHandlers:
    ...
    Attributes:
        kernel: Reference to the FlowbookKernel instance
    """

    def __init__(self, kernel: "FlowbookKernel"):
        """
        Initialize handler with kernel reference.

        Args:
            kernel: The FlowbookKernel instance to operate on
        """
        self.kernel = kernel
