...
class CodeExecutionOrchestrator:
    ...
    def test_code(
        ...
        try:
            ...
            try:
                self.cmd_client.checkpoint_delete("modified_result")
