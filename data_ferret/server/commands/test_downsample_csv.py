...
from data_ferret.server.kernel_helper import CSV_DOWNSAMPLE_PATCH_TEMPLATE
...
class TestDownsampleCSVKernel:
    ...
    def test_patch_works_in_kernel(self):
        ...
        from data_ferret.cli.helpers import setup_kernel, cleanup_kernel
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            kernel_manager, kernel_client = setup_kernel(kernel_name="ferret_kernel")
            try:
