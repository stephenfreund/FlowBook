"""
Tests for kernel/ferret_kernel.py - FerretKernel class and checkpoint dispatch.
...
from data_ferret.kernel.ferret_kernel import FerretKernel, CHECKPOINT_COMMANDS
from data_ferret.kernel.models import ExecutionContext
...
class TestErrorResultFormat:
    ...
    def test_monotonicity_error_format(self):
        ...
        from data_ferret.kernel.models import MonotonicityViolation
...
class TestDisplayMetadataFormat:
    ...
    def test_execution_metadata_format(self):
        ...
        from data_ferret.kernel.models import ExecutionProfile, ExecutionMetadata, TrackingData
