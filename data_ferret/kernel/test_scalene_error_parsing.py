...
Traceback (most recent call last):
  File "/Users/freund/anaconda3/envs/ferret/lib/python3.12/site-packages/scalene/scalene_profiler.py", line 1687, in profile_code
    exec(code, the_globals, the_locals)
  File "/Users/freund/other/DataFerret/examples/_ipython-input-1-profile", line 1, in <module>
    _val = print(N / 0)
                 ~~^~~
...
Traceback (most recent call last):
  File "/Users/freund/anaconda3/envs/ferret/lib/python3.12/site-packages/scalene/scalene_profiler.py", line 1687, in profile_code
    exec(code, the_globals, the_locals)
  File "/Users/freund/other/DataFerret/examples/_ipython-input-1-profile", line 2, in <module>
    print(foo)
          ^^^
