"""
Command-line interface for analyzing metadata from data_ferret commands.
...
def metadata_cli_main() -> int:
    """
    Command-line interface for analyzing metadata from ferret commands.
    ...
    parser = argparse.ArgumentParser(
        description="Analyze metadata from data_ferret commands",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Analyze a single metadata file
  data_ferret_metadata metadata.json

  # Analyze multiple metadata files
  data_ferret_metadata run1_metadata.json run2_metadata.json run3_metadata.json

  # Analyze all metadata files in current directory
  data_ferret_metadata *.json
        """,
    )
