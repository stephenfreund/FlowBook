"""
Ferret SDC Kernel - Sequential Dataflow Consistency enforcement.

This package provides:
- FerretSDCKernel: IPython kernel with SDC enforcement
...
def install_sdc_kernel() -> str:
    """
    Install the Ferret SDC kernel spec.
