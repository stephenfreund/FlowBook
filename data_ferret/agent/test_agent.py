...
from data_ferret.agent.agent import FerretAgent, FerretContext, FerretStats
...
class TestFerretAgent:
    """Test cases for FerretAgent."""

    def setup_method(self):
        """Set up test fixtures."""
        # Reset counters before each test
        FerretAgent.counters = {}
        
    def test_initialization_basic(self):
        """Test basic FerretAgent initialization."""
    ...
    def test_initialization_with_output_type(self):
        """Test FerretAgent initialization with output type."""
        with tempfile.TemporaryDirectory() as temp_dir:
            agent = FerretAgent(
                key="test-agent",
                model="openai/gpt-4o-mini", 
    ...
    def test_initialization_with_tools(self):
        """Test FerretAgent initialization with tools."""
    ...
    def test_make_unique(self):
        ...
        unique1 = FerretAgent.make_unique("test")
        assert unique1 == "test-1"
        
        # Second call should return "test-2"
        unique2 = FerretAgent.make_unique("test")
        assert unique2 == "test-2"
        
        # Different key should start from 1
        unique3 = FerretAgent.make_unique("other")
    ...
    def test_ferret_context(self):
        """Test FerretContext initialization."""
    ...
    def test_ferret_stats_initialization(self):
        """Test FerretStats initialization."""
    ...
    @patch('data_ferret.agent.agent.Runner')
    async def test_run_method_mock(self, mock_runner):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Mock the session
            with patch('data_ferret.agent.agent.SQLiteSession') as mock_session_class:
                mock_session = Mock()
                ...
                with patch.object(agent, 'on_agent_start') as mock_start, \
                    ...
                    assert isinstance(stats, FerretStats)
...
if __name__ == "__main__":
    ...
    test_instance.test_ferret_context()
    print("✓ FerretContext test passed")
    
    test_instance.test_ferret_stats_initialization()
    print("✓ FerretStats test passed")
